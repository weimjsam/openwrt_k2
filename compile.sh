...
curl ca-bundle unzip luci dnsmasq-full kmod-macvlan kmod-nft-connlimit \
...
# fw4 : -firewall4 -nftables -kmod-nft-offload -kmod-nft-offload -kmod-nft-core -kmod-nft-nat -kmod-nft-fib \
