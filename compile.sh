...
make info
make image PROFILE=${image_name} PACKAGES="luci-app-smartdns luci-i18n-smartdns-zh-cn smartdns iptables-nft luci-i18n-firewall-zh-cn vsftpd openssh-sftp-server uhttpd uhttpd-mod-ubus libiwinfo-lua luci-base luci-base luci-proto-ppp luci-mod-admin-full luci-theme-bootstrap luci-i18n-base-zh-cn wpad-openssl \
