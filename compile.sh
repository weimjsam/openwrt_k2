 ...
 xz -d openwrt-imagebuilder-${version}-ramips-mt7621.Linux-x86_64.tar.xz
 tar -xvf openwrt-imagebuilder-${version}-ramips-mt7621.Linux-x86_64.tar
 cd openwrt-imagebuilder-${version}-ramips-mt7621.Linux-x86_64
 make info
