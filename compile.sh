...
make info
make image PROFILE=${image_name} PACKAGES=" -firewall4  -nftables -procd-ujail  -procd-seccomp -odhcp6c  -odhcpd-ipv6only  -ip6tables  \
firewall iptables kmod-ipt-offload  \
