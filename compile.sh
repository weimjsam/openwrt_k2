...
xz -d openwrt-imagebuilder-${version}-${targets}-${mips}.Linux-x86_64.tar.zst
...
libevent2-7 libopenssl3 dnsmasq tc-full kmod-ifb kmod-sched kmod-sched-core kmod-netem iptables-mod-conntrack-extra \
