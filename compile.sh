...
make info
make image PROFILE=${image_name} PACKAGES="kmod-ipt-nat kmod-ipt-nfqueue kmod-ipt-offload iptables firewall luci-i18n-firewall-zh-cn  vsftpd openssh-sftp-server uhttpd uhttpd-mod-ubus libiwinfo-lua luci-base luci-base luci-proto-ppp luci-mod-admin-full luci-theme-bootstrap luci-i18n-base-zh-cn wpad-openssl  \
