...
uhttpd -dnsmasq dnsmasq-full openssh-sftp-server firewall4 luci-base luci-proto-ppp luci-mod-admin-full luci-theme-bootstrap luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn \
