...
firewall iptables-legacy dnsmasq-full kmod-ipt-offload kmod-ipt-nat kmod-ipt-conntrack kmod-ipt-conntrack-extra iptables-mod-conntrack-extra kmod-ipt-raw kmod-tcp-bbr \
...
-kmod-nft-arp  -kmod-nft-bridge -kmod-netfilter -libnftables1 \
