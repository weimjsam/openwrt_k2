...
openssh-sftp-server luci-app-smartdns luci-i18n-smartdns-zh-cn smartdns kmod-tcp-bbr firewall4 luci-i18n-firewall-zh-cn luci-base luci-proto-ppp luci-mod-admin-full luci-theme-bootstrap luci-i18n-base-zh-cn wpad-openssl \
