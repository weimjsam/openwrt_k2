...
make info
make image PROFILE=${image_name} PACKAGES="-firewall4 -kmod-nft-offload -nftables -procd-seccomp -procd-ujail libxtables12 libip4tc2 kmod-ipt-nat firewall iptables kmod-ipt-offload \
