...
-kmod-ipt-nat6 -kmod-ipt-raw6 -kmod-iptunnel6 -kmod-nf-nat6 -kmod-nf-reject6 -kmod-nft-nat6 -kmod-udptunnel6 -kmod-sit -firewall4 -nftables -kmod-nft-offload \
...
"base-files=1693~f919e7899d" "libc=1.2.5-r5" "kernel=6.12.71~364f8debbcd4cddc1f038dea515bf8a5-r1" \
